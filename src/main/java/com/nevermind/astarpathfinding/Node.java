...
public class Node {
    ...
    public boolean equals(Object o) {
        ...
        Node node = (Node) o;
        return isBorder == node.isBorder && visited == node.visited && Double.compare(node.localGoal, localGoal) == 0 && Double.compare(node.globalGoal, globalGoal) == 0 && x == node.x && y == node.y && Objects.equals(neighbours, node.neighbours) && Objects.equals(parent, node.parent);
    }
